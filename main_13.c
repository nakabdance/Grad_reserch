...
double x[NUM_INPUT + 1], h[NUM_HIDDEN + 1], y[NUM_OUTPUT];				  // 閾値表現用に１つ余分に確保。
double next_x[NUM_INPUT + 1], next_h[NUM_HIDDEN + 1], next_y[NUM_OUTPUT]; // 閾値表現用に１つ余分に確保。
